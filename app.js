...
Ext.application({
	...
	launch : function() {
        ...
        EvaluateIt.config = {
		    ...
		    // POST ad hoc evaluation: http://staging.metroblooms.org/api/nomination/addWithEvaluation?token=	
		    // POST evaluation update: http://staging.metroblooms.org/api/evaluation/update?token=	
			
			// POST image with id: http://staging.metroblooms.org/api/evaluation/uploadImage.
		    ...
		    // GET data: http://staging.metroblooms.org/api/evaluation/evaluator_id/265?token=
